...
public class GerenciadorSessaoTeste {
	...
	public void deveRetornarFalseQuandoNaoCabe () {
		...
		List<Sessao> sessoesExistentes = Arrays.asList (new Sessao (LocalTime.of(13, 00), new Filme ("Velozes e Furiosos", Duration.ofMinutes(120), "Ação"), sala), new Sessao (LocalTime.of(13, 00), new Filme ("A Origem", Duration.ofMinutes(90), "Ação"), sala), new Sessao (LocalTime.of(13, 00), new Filme ("Velozes e Furiosos", Duration.ofMinutes(120), "Ação"), sala));
