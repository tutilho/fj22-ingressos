...
public class FilmeController {
    ...
    @Autowired
    private SessaoDao sessaoDao; //4.3.
    ...
    public ModelAndView detalhes (@PathVariable ("id") Integer id) {
    	...
    	// Optional <DetalhesDoFilme> detalhesDoFilme = client.request(filme); //4.3.
    	
    	modelAndView.addObject ("sessoes", sessoes);
    	modelAndView.addObject ("detlhes", detalhesDoFilme.orElse (new DetalhesDoFilme()));
